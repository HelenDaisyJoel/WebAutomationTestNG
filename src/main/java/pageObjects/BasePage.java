...
//    private By successMessage = By.xpath("(//div[@class='MuiAlert-message css-1xsto0d'])[1]");
    private By successMessage = By.xpath("(//div[@class='MuiAlert-message css-1pxa9xg-MuiAlert-message'])[1]");
...
//    private static final By DISABLE = By.xpath("//li[normalize-space()='Disable']");
    ...
    private static final By DISABLE = By.xpath("//li[normalize-space()='Disable']//div[@class='MuiListItemIcon-root css-cveggr-MuiListItemIcon-root']");
